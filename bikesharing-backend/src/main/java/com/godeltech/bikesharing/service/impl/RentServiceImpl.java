...
import com.godeltech.bikesharing.service.util.RentCostCalculator;
...
public class RentServiceImpl implements RentService {
  ...
  private final RentCostCalculator calculator;
  ...
  public RentOperationModel startRentOperation(RentOperationModel rentOperationModel) {
    ...
    calculator.setFinishTimeAndTotalCost(rentOperationModel);
